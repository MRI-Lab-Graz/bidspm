(function () {
  ...
  function createTransformerBuilderColumns(config) {
    ...
    function inferFilterDomain(query, inputColumn, inputValues) {
      ...
      // Single-clause anchored regex alternation, e.g. `col==^(a|b|c)$` — the form
      // generated by the Filter step's multi-value pills, and the only compound form
      // the backend (bids.transformers Filter) actually executes.
